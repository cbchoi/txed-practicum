...
/**
 * Week 2 Behavioral Patterns 자동 채점기
 * Decorator Pattern을 사용하여 다양한 채점 기준을 조합
 */
public class Week2AutoGrader {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Week 2 Behavioral Patterns Auto-Grader");
        System.out.println("======================================");
        ...
        try {
            // 채점 실행
            Week2AutoGrader grader = new Week2AutoGrader();
    ...
    private Grader buildGraderChain() {
        ...
        // 2. Observer Pattern 검증 데코레이터 추가
        grader = new ObserverPatternGrader(grader);

        // 3. Command Pattern 검증 데코레이터 추가
        grader = new CommandPatternGrader(grader);
    ...
    public static class GraderBuilder {
        ...
        /**
         * Observer Pattern만 검증하는 채점기 생성
         */
        public static Grader createObserverOnlyGrader() {
            return new ObserverPatternGrader(new BasicGrader());
        }

        /**
         * Command Pattern만 검증하는 채점기 생성
         */
        public static Grader createCommandOnlyGrader() {
            return new CommandPatternGrader(new BasicGrader());
        }

        /**
         * 통합 테스트만 수행하는 채점기 생성 (Observer와 Command가 모두 구현되어 있다고 가정)
         */
        ...
        /**
         * Observer와 Command만 검증하는 채점기 생성 (통합 테스트 제외)
         */
    ...
    public static void printUsage() {
        System.out.println("Usage: java com.orca.patterns.grading.Week2AutoGrader [student_package] [output_directory]");
        System.out.println();
        ...
        System.out.println("  java com.orca.patterns.grading.Week2AutoGrader");
        System.out.println("  java com.orca.patterns.grading.Week2AutoGrader com.student.solution");
        System.out.println("  java com.orca.patterns.grading.Week2AutoGrader com.student.solution ./results");
        System.out.println();
        System.out.println("Expected classes in student package:");
        System.out.println("Observer Pattern:");
        System.out.println("  - EventObserver (interface)");
        System.out.println("  - ProcessEvent (class)");
        System.out.println("  - EventPublisher (class)");
        System.out.println("  - LoggingObserver (class)");
        System.out.println("  - AlertingObserver (class)");
        System.out.println();
        System.out.println("Command Pattern:");
        System.out.println("  - Command (interface)");
        System.out.println("  - ProcessCommand (class)");
        System.out.println("  - CommandInvoker (class)");
        System.out.println();
        System.out.println("Integration:");
        System.out.println("  - Week2_BehavioralPatterns_Solution (class with main method)");
    }
    ...
    public static void performSteppedGrading(String studentPackage) {
        ...
        try {
            // 1단계: Observer Pattern만
            System.out.println("Step 1: Observer Pattern Grading");
            System.out.println("-".repeat(40));
            Grader observerGrader = GraderBuilder.createObserverOnlyGrader();
            GradeResult observerResult = observerGrader.grade(studentPackage);
            System.out.println("Observer Result: " + observerResult);
            System.out.println();

            // 2단계: Command Pattern만
            System.out.println("Step 2: Command Pattern Grading");
            System.out.println("-".repeat(40));
            Grader commandGrader = GraderBuilder.createCommandOnlyGrader();
            GradeResult commandResult = commandGrader.grade(studentPackage);
     ...
     * 개발자용 메소드: 특정 패턴만 테스트
     */
    public static void testSpecificPattern(String studentPackage, String patternType) {
        System.out.println("=== PATTERN-SPECIFIC TESTING ===");
        System.out.println("Pattern: " + patternType.toUpperCase());
        System.out.println("Package: " + studentPackage);
        System.out.println("-".repeat(40));
        ...
        try {
            ...
            switch (patternType.toLowerCase()) {
                case "observer":
                    grader = GraderBuilder.createObserverOnlyGrader();
                    break;
                case "command":
                    grader = GraderBuilder.createCommandOnlyGrader();
                    break;
                case "integration":
                    grader = GraderBuilder.createIntegrationOnlyGrader();
                    break;
                default:
                    System.err.println("Unknown pattern type: " + patternType);
                    System.err.println("Available patterns: observer, command, integration");
                    return;
            }
            ...
            System.out.println("Pass rate: " + String.format("%.1f%%", result.getPassRate()));
            ...
            System.err.println("Pattern-specific testing failed: " + e.getMessage());
        }
    }
}